...
//
//     final problemsModels = problemsModelsFromJson(jsonString);

import 'dart:convert';

List<ProblemsModels> problemsModelsFromJson(String str) =>
    List<ProblemsModels>.from(
        json.decode(str).map((x) => ProblemsModels.fromJson(x)));

String problemsModelsToJson(List<ProblemsModels> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProblemsModels {
  ProblemsModels({
    this.id,
    this.date,
    this.dateGmt,
  ...
  factory ProblemsModels.fromJson(Map<String, dynamic> json) => ProblemsModels(
        id: json["id"],
