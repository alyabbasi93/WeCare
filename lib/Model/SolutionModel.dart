...
//
//     final solutionModel = solutionModelFromJson(jsonString);

import 'dart:convert';

List<SolutionModel> solutionModelFromJson(String str) =>
    List<SolutionModel>.from(
        json.decode(str).map((x) => SolutionModel.fromJson(x)));

String solutionModelToJson(List<SolutionModel> data) =>
...
class Sizes {
  ...
  factory Sizes.fromJson(Map<String, dynamic> json) => Sizes(
        ...
        mediumLarge: json["medium_large"] == null
            ? null
            : CherryBlogDefault.fromJson(json["medium_large"]),
        cherryBlogDefault:
